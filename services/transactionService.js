...
function extractCleanTransactionFrom(mongoDbTransaction) {
  const { _id, description, value, category, year, month, day, yeaMonth, yearMonthDay, type } = mongoDbTransaction;
}
...
module.exports = { getTransactionsFrom, postTransaction, updateTransaction, deleteTransaction };